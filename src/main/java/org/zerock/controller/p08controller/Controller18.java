...
//	@RequestMapping(value = "/met05", method = {RequestMethod.GET})
	...
	@PostMapping("/met06")
//	@RequestMapping(value = "/met05", method = {RequestMethod.POST})
	public String method06() {
		return "";
	}
	
	@PutMapping("/met07")
//	@RequestMapping(value = "/met05", method = {RequestMethod.PUT})
	public String method07() {
		return "";
	}
	
	@DeleteMapping("/met08")
//	@RequestMapping(value = "/met05", method = {RequestMethod.DELETE})
