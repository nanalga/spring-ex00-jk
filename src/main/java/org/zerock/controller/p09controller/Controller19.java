...
public class Controller19 {
	...
	public void method02(MultipartFile file1, MultipartFile file2) {
		if(file1 != null) {
			...
			String path = "C:\\Users\\user\\Desktop\\COURS\\fileupload\\" + file1.getOriginalFilename();
			File dest = new File(path);
		...
		if(file2 != null) {
			...
			String path = "C:\\Users\\user\\Desktop\\COURS\\fileupload\\" + file2.getOriginalFilename();
			File dest = new File(path);
	...
	public void method03(MultipartFile[] files) {
		for(MultipartFile file : files) {
			if(file != null) {
				...
				String path = "C:\\Users\\user\\Desktop\\COURS\\fileupload\\" + file.getOriginalFilename();
