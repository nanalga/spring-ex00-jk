...
public class Controller11 {
	...
	public void method02(Integer id) {
		String customerName = mapper.getCustomerNameId(id);
	...
	public void method04(String category, Double price) {
		List<String> productsNames = mapper.getProductNamesByCategoryAndPrice(category, price);
		
		for(String p : productsNames) {
			System.out.println(p);
		}
	}
