...
$(document).ready(function() {
  ...
  $("#btn05").click(function(){
	  const valName = $("#input05").val();
	  const valAdd = $("#input06").val();
	  $.ajax({
...
<button id="btn05">/cont14/met05 ajax 요청 : 위 2개의 요소의 값이 전송 되도록 AND server에서는 두 값을 출력</button>
<hr>
