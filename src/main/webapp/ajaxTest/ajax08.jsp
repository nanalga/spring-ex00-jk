...
$(document).ready(function(){
	...
	$("#btn02").click(function(){
		$.ajax({
			url : appRoot + "/cont17/met02/" + 321
		});
	});
	
	$("#btn03").click(function(){
		$.ajax({
			url : appRoot + "/cont17/met03/" + 456
		});
	});
	...
	$("#btn06").click(function(){
		$.ajax({
			url : appRoot + "/cont17/met06/id/123/city/LA"
		});
	});
...
<button id="btn03">/cont17/met03/number 요청 : controller에서 바뀔수 있는 number를 sysout으로 출력</button>
