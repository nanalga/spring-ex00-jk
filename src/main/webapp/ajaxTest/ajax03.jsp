...
<button id="btn02">/cont13/net03 응답있음 jsp 페이지 전체</button> <br>
...
<p id="result08"></p>
<button id="btn09">/cont13/met08 요청시 complet 실행</button>
<button id="btn10">/cont13/met09 요청시 success/erro AND complete 실행 </button>
