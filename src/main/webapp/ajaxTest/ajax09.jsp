...
$(document).ready(function(){
	...
	$("#btn01").click(function(){
		$.ajax({
			...
			type : "delete"	// method는 type속성으로 변경 가능, 값은 HTTP Method (ex: get, post, put, delete)
		});
	});
...
<button id="btn021">/cont18/met02 요청 get</button>
<button id="btn022">/cont18/met03 요청 post</button>
<button id="btn023">/cont18/met04 요청 put</button>
<button id="btn024">/cont18/met02 요청 delete</button>
