...
<body>
 ...
 <div class="container">
 	<div class="row">
 		<div class="col">
 			<h1>회원정보</h1>
 			<!-- form>.form-group*4>label[for=input$]+input#input$.form-control[name][value] -->
 			<form method="post" id="infoForm">
 				...
 				<div class="form-group">
 					...
 					<input type="text" required id="input4" class="form-control" name="email" value="${sessionScope.loggedInMember.email }">
 				</div>
 				<div class="form-group">
 				...
 				<button class="btn btn-outline-secondary" id="mofifyButton">수정</button>
